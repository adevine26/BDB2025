...
ggplot(noDL, aes(x = distanceSinceLineset, color = position_group)) +
  geom_density(size = 1, alpha = 0.6) +
  theme_minimal() +
  facet_wrap(~ pff_manZone, labeller = label_both) +
  labs(title = "Density of Overall Movement (deltaDistance) by Defensive Scheme",
       x = "deltaDistance (Overall Movement)",
       y = "Density",
